...
class Provincia:
    ...
    def getTemperatura(self):
        valor=self.obtenerJson(self.__nombre) #Obtiene el valor de la página web
    ...
    def verificador(self, valor, mensaje): #Para verificar formatos
        if not valor:
            raise ValueError(mensaje)
        return valor


    def verificadorNombre(self, valor, mensaje): #Para verificar formatos
